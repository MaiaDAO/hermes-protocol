...
contract tokenizer {
    ...
    function tokenURI(uint tokenId, uint balanceOf, uint locked_end, uint value) public pure returns (string memory output) {
        ...
        output = string(abi.encodePacked(output, "locked_end ", toString(locked_end), '</text><text x="10" y="80" class="base">'));
